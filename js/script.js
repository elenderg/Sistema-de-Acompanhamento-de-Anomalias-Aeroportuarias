...
function renderMapMarkers() {
  ...
  Object.values(airports).forEach(a => {
    ...
    let lat = a.lat || -15.8; let lon = a.lon || -47.9;
    let circle = L.circle([lat, lon], { radius: 40000 / Math.max(1, Math.abs(status.level || 1)), color: col, fillColor: col, fillOpacity: 0.35 }).addTo(map);
